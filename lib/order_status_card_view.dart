...
import 'package:safiri/chat/chat.graphql.dart';
import 'package:safiri/graphql/order.fragment.graphql.dart';
import 'package:safiri/main.graphql.dart';
import 'package:safiri/order_invoice_view.dart';
import 'package:safiri/query_result_view.dart';
import 'package:safiri/ride_options_sheet_view.dart';
import 'package:safiri/rider_preferences_sheet_view.dart';
  ...
  _launchUrl(BuildContext context, String url) async {
    ...
    if (!canLaunch) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: RiddyBanner(S.of(context).message_cant_open_url,
