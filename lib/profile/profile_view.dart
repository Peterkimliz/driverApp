...
import 'package:safiri/profile/profile.graphql.dart';
import 'package:safiri/profile/profile_info_card.dart';
import 'package:safiri/unit_of_measurement.dart';
    ...
    return Scaffold(
      body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              SafiriBackButton(text: S.of(context).action_back),
